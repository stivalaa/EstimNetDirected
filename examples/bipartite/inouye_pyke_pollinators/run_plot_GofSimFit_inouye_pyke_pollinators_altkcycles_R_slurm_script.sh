...
#SBATCH --job-name="plotGofSimFit-inouye_pyke_pollinators_altkcycles"
#SBATCH --ntasks=1
#SBATCH --time=0-01:00:00
#SBATCH --cpus-per-task=20
#SBATCH --mem-per-cpu=1GB
#SBATCH --output=PlotGofSimFit-inouye_pyke_pollinators_altkcycles-%j.out
#SBATCH --error=PlotGofSimFit-inouye_pyke_pollinators_altkcycles-%j.err
