...
#SBATCH --output=SimulateERGM_gof_ifd_netscience-%j.out
#SBATCH --error=SimulateERGM_gof_ifd_netscience-%j.err

echo -n "started at: "; date

ROOT=../..

SIM_FILE_PREFIX=sim_gof_netscience_ifd
STATS_FILE=stats_gof_netscience_ifd.txt
GOF_CONFIG_FILE=config_gof_netscience_ifd.txt
...
time Rscript ${ROOT}/scripts/plotSimulationDiagnostics.R  ${STATS_FILE}  obs_stats_ifd_netscience_0.txt
