...
#SBATCH --job-name="SimulateERGM_IFD_GOF"
#SBATCH --ntasks=1
...
config_tmpfile=sim_config_estimated_ifd_allowloops_sim_n1000_sample.txt
statsfile=stats_estimated_ifd_allowloops_sim_n1000_sample.txt
simfileprefix=gof_estimated_ifd_allowloops_sim_n1000_sample


rm ${simfileprefix}_*.net

# generate SimulationERGM config file with parameter values from estimation
${ROOT}/scripts/estimnetdirectedEstimation2simulationConfig.sh  config_example_ifd_allowloops.txt estimation_ifd_allowloops_sim_n1000_sample.out ${statsfile} ${simfileprefix} > ${config_tmpfile}
