...
do
    ...
    do
        ...
        time ${implementation} ../../examples/bipartite/simulated/bpnet_A12000_B4000_attrs_sim830000000.net ../../examples/bipartite/simulation/catattr_all.txt $exponent >> ${OUTPUT}
        if [ $? -ne 0 ]; then
            echo "**** FAILED ****"
            exit 1
        fi
