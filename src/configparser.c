...
static const struct_param_t STRUCT_PARAMS[] =
{
  ...
  {"AltStarsA",         STRUCT_PARAM_TYPE_LAMBDA, NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeAltStarsA},
  {"AltStarsB",         STRUCT_PARAM_TYPE_LAMBDA, NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeAltStarsB},
  {"BipartiteFourCycle",STRUCT_PARAM_TYPE_LAMBDA, NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeBipartiteFourCycle},
  {"AltKCyclesA"       ,STRUCT_PARAM_TYPE_LAMBDA, NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeAltKCyclesA},
  {"AltKCyclesB"       ,STRUCT_PARAM_TYPE_LAMBDA, NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeAltKCyclesB}
};
