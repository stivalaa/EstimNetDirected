...
static const attr_param_t ATTR_PARAMS[] =
{
  ...
  {"BipartiteTwoPathSumA",        ATTR_TYPE_CONTINUOUS,  NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeBipartiteTwoPathSumA},
  {"BipartiteTwoPathSumB",        ATTR_TYPE_CONTINUOUS,  NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeBipartiteTwoPathSumB},
  {"BipartiteTwoPathDiffA",       ATTR_TYPE_CONTINUOUS,  NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeBipartiteTwoPathDiffA},
  {"BipartiteTwoPathDiffB",       ATTR_TYPE_CONTINUOUS,  NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeBipartiteTwoPathDiffB},
  {"BipartiteTwoPathMatchingA",   ATTR_TYPE_CATEGORICAL, NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeBipartiteTwoPathMatchingA},
  {"BipartiteTwoPathMatchingB",   ATTR_TYPE_CATEGORICAL, NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeBipartiteTwoPathMatchingB},
  {"BipartiteTwoPathMismatchingA",ATTR_TYPE_CATEGORICAL, NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeBipartiteTwoPathMatchingA},
  {"BipartiteTwoPathMismatchingB",ATTR_TYPE_CATEGORICAL, NETWORK_TYPE_UNDIRECTED, NETWORK_MODE_TWOMODE, changeBipartiteTwoPathMatchingB}
};
